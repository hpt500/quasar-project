...
module.exports = function (ctx) {
    return {
        ...
        framework: {
            ...
            directives: [
                'Ripple', 'GoBack', 'ClosePopup', 'Scroll'
            ],
        ...
        build: {
            ...
            extendWebpack(cfg) {
                // web打包后的资源路径分配(quasar的ssr模式不支持资源路径更改)
                // 非ssr模式需取消该程序
                // cfg.output.publicPath = ctx.dev ? '/' : '/'
            },
            // 打包处理
            uglifyOptions: {
                compress: {
            ...
            chainWebpack(chain, { isServer, isClient }) {
                chain.resolve.alias
                    .set('css', path.resolve(__dirname, './src/css')) // 样式层
        ...
        pwa: {
            ...
            manifest: {
                ...
                // description: 'This is a basic development environment',
                display: 'standalone',
